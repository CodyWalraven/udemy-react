...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handleAddOption(choice) {
      ...
      var option = choice.target.elements.option.value.trim();
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Action, { hasOptions: this.state.options.length > 0, handleOnPick: this.handleOnPick }),
  ...
  _createClass(Action, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          "button",
          { onClick: this.props.handleOnPick,
